...
def simulate(interval=10, first_reset=302, rounds=4, work_minutes=60,
...
def main():
    scenarios = {}
    for delay in (2, 12):
        scenarios['first_reset_' + str(delay) + '_minutes_late'] = [simulate(interval=i, first_reset=300 + delay) for i in (300, 305, 310, 10)]
    scenarios['one_post_reset_tick_also_missed'] = simulate(missed_ticks=(310,))
